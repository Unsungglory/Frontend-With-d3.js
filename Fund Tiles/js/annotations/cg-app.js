    ...
    function setCursor(size) {
        ...
        if (isErasing) {
            ...
            if (size === 'big') {
                switch (color) {
                    case 'rgb(255, 255, 0)':
                        cursor.style.cursor = `url('engine/imgs/highlighter-orange-lg.svg') ${offset1}`;
                        return;
                    case 'rgb(255, 76, 76)':
                        cursor.style.cursor = `url('engine/imgs/highlighter-red-lg.svg') ${offset1}`;
                        return;
                    case 'rgb(255, 76, 255)':
                        cursor.style.cursor = `url('engine/imgs/highlighter-violet-lg.svg') ${offset1}`;
                        return;
                    case 'rgb(76, 137, 253)':
                        cursor.style.cursor = `url('engine/imgs/highlighter-blue-lg.svg') ${offset1}`;
                        return;
                    case 'rgb(52, 227, 0)':
                        cursor.style.cursor = `url('engine/imgs/highlighter-green-lg.svg') ${offset1}`;
                        return;
                    default:
                ...
                switch (color) {
                    case 'rgb(255, 255, 0)':
                        cursor.style.cursor = `url('engine/imgs/highlighter-orange-med.svg') ${offset1}`;
                        return;
                    case 'rgb(255, 76, 76)':
                        cursor.style.cursor = `url('engine/imgs/highlighter-red-med.svg') ${offset1}`;
                        return;
                    case 'rgb(255, 76, 255)':
                        cursor.style.cursor = `url('engine/imgs/highlighter-violet-med.svg') ${offset1}`;
                        return;
                    case 'rgb(76, 137, 253)':
                        cursor.style.cursor = `url('engine/imgs/highlighter-blue-med.svg') ${offset1}`;
                        return;
                    case 'rgb(52, 227, 0)':
                        cursor.style.cursor = `url('engine/imgs/highlighter-green-med.svg') ${offset1}`;
                        return;
                    default:
                        console.log('bad color');
                        cursor.style.cursor = `url('engine/imgs/highlighter-orange-med.svg') ${offset1}`;
                ...
                switch (color) {
                    case 'rgb(255, 255, 0)':
                        cursor.style.cursor = `url('engine/imgs/highlighter-orange-sm.svg') ${offset1}`;
                        return;
                    case 'rgb(255, 76, 76)':
                        cursor.style.cursor = `url('engine/imgs/highlighter-red-sm.svg') ${offset1}`;
                        return;
                    case 'rgb(255, 76, 255)':
                        cursor.style.cursor = `url('engine/imgs/highlighter-violet-sm.svg') ${offset1}`;
                        return;
                    case 'rgb(76, 137, 253)':
                        cursor.style.cursor = `url('engine/imgs/highlighter-blue-sm.svg') ${offset1}`;
                        return;
                    case 'rgb(52, 227, 0)':
                        cursor.style.cursor = `url('engine/imgs/highlighter-green-sm.svg') ${offset1}`;
                        return;
                    default:
                        console.log('bad color');
                        cursor.style.cursor = `url('engine/imgs/highlighter-orange-sm.svg') ${offset1}`;
            ...
            if (size === 'big') {
                switch (color) {
                    case 'rgb(255, 255, 0)':
                        cursor.style.cursor = `url('engine/imgs/pen-tip-20-orange.svg') ${offset2}`;
                        return;
                    case 'rgb(255, 76, 76)':
                        cursor.style.cursor = `url('engine/imgs/pen-tip-20-red.svg') ${offset2}`;
                        return;
                    case 'rgb(255, 76, 255)':
                        cursor.style.cursor = `url('engine/imgs/pen-tip-20-violet.svg') ${offset2}`;
                        return;
                    case 'rgb(76, 137, 253)':
                        cursor.style.cursor = `url('engine/imgs/pen-tip-20-blue.svg') ${offset2}`;
                        return;
                    case 'rgb(52, 227, 0)':
                        cursor.style.cursor = `url('engine/imgs/pen-tip-20-green.svg') ${offset2}`;
                        return;
                    default:
                        console.log('bad color');
                        cursor.style.cursor = `url('engine/imgs/pen-tip-20-orange.svg') ${offset2}`;
                ...
                switch (color) {
                    case 'rgb(255, 255, 0)':
                        cursor.style.cursor = `url('engine/imgs/pen-tip-15-orange.svg') ${offset3}`;
                        return;
                    case 'rgb(255, 76, 76)':
                        cursor.style.cursor = `url('engine/imgs/pen-tip-15-red.svg') ${offset3}`;
                        return;
                    case 'rgb(255, 76, 255)':
                        cursor.style.cursor = `url('engine/imgs/pen-tip-15-violet.svg') ${offset3}`;
                        return;
                    case 'rgb(76, 137, 253)':
                        cursor.style.cursor = `url('engine/imgs/pen-tip-15-blue.svg') ${offset3}`;
                        return;
                    case 'rgb(52, 227, 0)':
                        cursor.style.cursor = `url('engine/imgs/pen-tip-15-green.svg') ${offset3}`;
                        return;
                    default:
                        console.log('bad color');
                        cursor.style.cursor = `url('engine/imgs/pen-tip-15-orange.svg') ${offset3}`;
                ...
                switch (color) {
                    case 'rgb(255, 255, 0)':
                        cursor.style.cursor = `url('engine/imgs/pen-tip-10-orange.svg') ${offset4}`;
                        return;
                    case 'rgb(255, 76, 76)':
                        cursor.style.cursor = `url('engine/imgs/pen-tip-10-red.svg') ${offset4}`;
                        return;
                    case 'rgb(255, 76, 255)':
                        cursor.style.cursor = `url('engine/imgs/pen-tip-10-violet.svg') ${offset4}`;
                        return;
                    case 'rgb(76, 137, 253)':
                        cursor.style.cursor = `url('engine/imgs/pen-tip-10-blue.svg') ${offset4}`;
                        return;
                    case 'rgb(52, 227, 0)':
                        cursor.style.cursor = `url('engine/imgs/pen-tip-10-green.svg') ${offset4}`;
                        return;
                    default:
                        cursor.style.cursor = `url('engine/imgs/pen-tip-10-orange.svg') ${offset4}`;
                        console.log('bad color');
