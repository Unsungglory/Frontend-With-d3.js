  ...
  `
        ...
        <button onclick="scrollToTop()">
          ...
          <ol class='dis-ol'>
            ...
            <li>
            <span>
            Both fund and index annualized returns reflect the average of the average annual total returns for all periods. Data from published sources were calculated internally. Fund returns, which are based on Class A shares at net asset value, are from 
            the first month-end following each fund’s inception date through December 31, 2020, and do not include the maximum sales charge of 5.75%. If a sales charge had been deducted, the results would have been lower. The percentage of periods funds outpaced the index were calculated based on the total return. 
            </span>
            </li>
