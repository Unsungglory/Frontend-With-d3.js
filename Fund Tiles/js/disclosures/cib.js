  ...
  `
        ...
        <button onclick="scrollToTop()">
          ...
          <ol class='dis-ol'>
            ...
            <li>
            <span>
            Calculated by Capital Group using the 70%/30% MSCI All Country World Index/Bloomberg Barclays U.S. Aggregate Index. Due to differing calculation methods, the figures shown here may differ from those calculated by Morningstar. 
            </span>
            </li>
            <br>
            ...
            <li>
            <span>
            Peer category average represents the Global Allocation category. There may be funds within these categories that outpaced or lagged their category average and/or the American Fund.
            </span>
            </li>
            <br>
          ...
          70%/30% MSCI ACWI/Bloomberg Barclays U.S. Aggregate Index blends the MSCI All Country World Index with the Bloomberg Barclays U.S. Aggregate Index by weighting their total returns at 70% and 30%, respectively. Results assume the blend is rebalanced monthly.
