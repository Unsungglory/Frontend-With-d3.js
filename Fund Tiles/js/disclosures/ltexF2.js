const LTEXF2disc =
  ...
  <br><br>
  lass F-2 shares were ﬁrst offered on August 1, 2008. Class F-2 share results prior to the date of ﬁrst sale are hypothetical based on the results of the original share class of the fund without a sales charge, adjusted for typical estimated expenses. Results for certain funds with an inception date after August 1, 2008, also include hypothetical returns because those funds’ Class F-2 shares sold after the funds’ date of ﬁrst offering. Please see <span style='text-decoration: underline; cursor: pointer;' onclick='goWeb()'>capitalgroup.com</span> for more information on speciﬁc expense adjustments and the actual dates of ﬁrst sale. 
