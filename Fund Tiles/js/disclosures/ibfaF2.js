const IBFAF2disc =
  ...
  <br><br>
  When applicable,
  investment results reflect fee waivers and/or expense reimbursements, without which results would have been
  lower and net expense ratios higher if shown. This information is provided in detail in the prospectus. Please
  see <span style='text-decoration: underline; cursor: pointer;' onclick='goWeb()'>capitalgroup.com</span> for more information.
